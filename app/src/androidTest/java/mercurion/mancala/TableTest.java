...
import mercurion.mancala.logic.TableHandler;
...
public class TableTest extends InstrumentationTestCase {
    ...
    public void testInitialTable () {
        ...
        assertEquals("player1's tray is well setted", 0, tableToTest.getTrayByPlayerId(1).getNumSeeds());
        assertEquals("player2's tray is well setted", 0, tableToTest.getTrayByPlayerId(2).getNumSeeds());
    ...
    public void testClearBowl () {
        ...
        assertEquals("All P1 seeds are in the right tray", pointsP1, tableToTest.getTrayByPlayerId(1).getNumSeeds());
        assertEquals("All P2 seeds are in the right tray", pointsP2, tableToTest.getTrayByPlayerId(2).getNumSeeds());
    }
